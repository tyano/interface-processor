...
import com.shelfmap.interfaceprocessor.impl.DefaultField;
    ...
    protected Field buildFieldFromVariableElement(VariableElement ve, Environment env) {
        ...
        if(ve.getKind() == ElementKind.FIELD) {
            ...
            for (AnnotationMirror annotation : annotations) {
                TypeElement fieldAnnotationType = elementUtil.getTypeElement(com.shelfmap.interfaceprocessor.annotation.Field.class.getName());
